...
class Burger_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Burger ] Social Links', 'burger-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'burger-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'burger-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'burger-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'burger-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'burger-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'burger-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'burger-companion'); ?></label>
...
} // Class burger_social_links ends here


// Register and load the widget
function burger_social_links_widget_load() {
	register_widget( 'Burger_social_links' );
}
add_action( 'widgets_init', 'burger_social_links_widget_load' );