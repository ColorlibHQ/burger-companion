(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".burger-service-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".burger-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".burger-team-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.burger-portfolio').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.burger-portfolio').isotope({
    ...
    // MC Scripts
    var $subscribe = $('.burger-subscribe-newsletter-area');
    if ($subscribe.length) {
